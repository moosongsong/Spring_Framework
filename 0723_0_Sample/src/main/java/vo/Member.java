...
public class Member {
    ...
    public Member(String email, String pass, String nick, Timestamp registerAt, Timestamp removeAt) {
        this.email = email;
        this.pass = pass;
        this.nick = nick;
    ...
    public String toString() {
        return "{" + "email='" + email + '\'' + ", pass='" + pass + '\'' + ", nick='" + nick + '\'' +
                ", registerAt=" + registerAt + ", removeAt=" + removeAt + '}';
    }
}
